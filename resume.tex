...
\textbf{OS} \hfill GNU/Linux (Ubuntu, Debian), Windows \\
...
\begin{itemize}
 \item Goal: Extract facial feature information from a live video feed of a person and predict the emotion portrayed.
 \item Technologies/Tools: C/C++, OpenCV, Linux, libSVM
\end{itemize}
